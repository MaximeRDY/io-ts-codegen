...
export declare type Combinator = InterfaceCombinator | UnionCombinator | LiteralCombinator | IntersectionCombinator | StrictCombinator | KeyofCombinator | ArrayCombinator | ReadonlyArrayCombinator | TupleCombinator | RecursiveCombinator | DictionaryCombinator | PartialCombinator | TaggedUnionCombinator | CustomCombinator;
...
export declare function printStaticWithoutFormatting(node: Node): string;
export declare const defaultOptions: Options;
export interface Options extends prettier.Options {
    parser: 'typescript';
}
export declare function printStatic(node: Node, options?: Options): string;
